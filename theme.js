...
function updateThemeToggleButton() {
  ...
  const icons = {
    ...
    system: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M4 6.41421L10.5858 13L4 19.5858L5.41421 21L12 14.4142L18.5858 21L20 19.5858L13.4142 13L20 6.41421L18.5858 5L12 11.5858L5.41421 5L4 6.41421Z"/></svg>`,
  };

  button.innerHTML = icons[currentTheme];
  button.setAttribute('title', `Theme: ${currentTheme} (click to toggle)`);
}
